...
export interface DailyInsight extends DailyInsightDecision {
  timestamp: string;
}
export interface RangeReview extends RangeReviewDecision {
  timestamp: string;
}
export interface WeeklyReview extends WeeklyReviewDecision {
  timestamp: string;
}
